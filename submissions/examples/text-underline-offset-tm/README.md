...
Text-underline-offset from auto to 8px with multiple link styles using ease-color tokens. This submission demonstrates how to leverage the EaseMotion CSS design token system (--ease-* variables) for consistent styling across your project.
