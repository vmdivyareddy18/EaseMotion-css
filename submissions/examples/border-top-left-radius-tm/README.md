...
<div class="tm-border-top-left-radius-tm tm-border-top-left-radius-tm-variant-1">
  <span>Left accent variant</span>
</div>

<!-- Variant 2: outline glow -->
<div class="tm-border-top-left-radius-tm tm-border-top-left-radius-tm-variant-2">
  <span>Outline glow variant</span>
</div>

<!-- Variant 3: tall column -->
<div class="tm-border-top-left-radius-tm tm-border-top-left-radius-tm-variant-3">
  <span>Tall column variant</span>
</div>

<!-- Variant 4: shadow depth -->
<div class="tm-border-top-left-radius-tm tm-border-top-left-radius-tm-variant-4">
