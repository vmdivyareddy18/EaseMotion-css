...
## CSS CSS filter sepia vintage effects

A comprehensive CSS utility class for **CSS filter sepia vintage effects**. Part of the EaseMotion CSS framework — a curated collection of modern CSS utilities designed for rapid UI development.

## Usage

```html
<!-- Basic usage -->
<div class="tm-filter-sepia-tm">
  <span>CSS filter sepia vintage effects</span>
</div>

<!-- Variant 1: left-accent border -->
<div class="tm-filter-sepia-tm tm-filter-sepia-tm-variant-1">
  <span>Left accent variant</span>
</div>

<!-- Variant 2: outline glow -->
<div class="tm-filter-sepia-tm tm-filter-sepia-tm-variant-2">
  <span>Outline glow variant</span>
</div>

<!-- Variant 3: tall column -->
<div class="tm-filter-sepia-tm tm-filter-sepia-tm-variant-3">
  <span>Tall column variant</span>
</div>

<!-- Variant 4: shadow depth -->
<div class="tm-filter-sepia-tm tm-filter-sepia-tm-variant-4">
