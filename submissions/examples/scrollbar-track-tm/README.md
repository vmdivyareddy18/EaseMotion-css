# CSS Scrollbar Track Custom

**Category:** Interaction
**Slug:** `scrollbar-track-tm`

## Overview

Cursors, scroll, selection, and user interaction styles.

This submission provides a comprehensive set of CSS utility classes for **CSS Scrollbar Track Custom**, built on the EaseMotion CSS design token system from `core/variables.css`.
...
```html
<link rel="stylesheet" href="submissions/examples/scrollbar-track-tm/style.css" />
```
...
```
submissions/examples/scrollbar-track-tm/
