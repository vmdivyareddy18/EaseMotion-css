# Chip High Contrast Mode Support

## Description
This submission enhances the `chip` component by adding comprehensive support for the `@media (prefers-contrast: more)` CSS feature. 
