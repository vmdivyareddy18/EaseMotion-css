# ease-skew-empty-state

**Issue:** #41625 — [FEATURE] Animated Empty State (Skew Style)

## What does this do?

An empty state illustration that skew-animates into view, creating a dynamic angled reveal effect.
...
```html
<!-- Example usage -->
<div class="ease-skew-empty-state">
  <!-- Your content here -->
</div>
```
