...
1. Ensure the core EaseMotion variables and utilities are imported.
2. Apply the `.alm-sticky-header` class to your `<header>` or `<nav>` container.
3. Structure your internal navigation links using `.alm-nav-logo`, `.alm-nav-menu`, and `.alm-nav-link`.
