...
Text-decoration-thickness from auto to 4px with underline offset demos using ease-color tokens. This submission demonstrates how to leverage the EaseMotion CSS design token system (--ease-* variables) for consistent styling across your project.
