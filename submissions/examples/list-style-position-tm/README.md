...
List-style-position inside outside with custom counter-styling using ease-space tokens. This submission demonstrates how to leverage the EaseMotion CSS design token system (--ease-* variables) for consistent styling across your project.
