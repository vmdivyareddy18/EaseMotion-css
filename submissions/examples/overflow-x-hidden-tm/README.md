...
## CSS CSS overflow-x horizontal clip

A comprehensive CSS utility class for **CSS overflow-x horizontal clip**. Part of the EaseMotion CSS framework — a curated collection of modern CSS utilities designed for rapid UI development.

## Usage

```html
<!-- Basic usage -->
<div class="tm-overflow-x-hidden-tm">
  <span>CSS overflow-x horizontal clip</span>
</div>

<!-- Variant 1: left-accent border -->
<div class="tm-overflow-x-hidden-tm tm-overflow-x-hidden-tm-variant-1">
  <span>Left accent variant</span>
</div>

<!-- Variant 2: outline glow -->
<div class="tm-overflow-x-hidden-tm tm-overflow-x-hidden-tm-variant-2">
  <span>Outline glow variant</span>
</div>

<!-- Variant 3: tall column -->
<div class="tm-overflow-x-hidden-tm tm-overflow-x-hidden-tm-variant-3">
  <span>Tall column variant</span>
</div>

<!-- Variant 4: shadow depth -->
<div class="tm-overflow-x-hidden-tm tm-overflow-x-hidden-tm-variant-4">
