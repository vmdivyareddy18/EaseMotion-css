...
## CSS CSS @keyframes slide motion animation

A comprehensive CSS utility class for **CSS @keyframes slide motion animation**. Part of the EaseMotion CSS framework — a curated collection of modern CSS utilities designed for rapid UI development.

## Usage

```html
<!-- Basic usage -->
<div class="tm-keyframes-slide-tm">
  <span>CSS @keyframes slide motion animation</span>
</div>

<!-- Variant 1: left-accent border -->
<div class="tm-keyframes-slide-tm tm-keyframes-slide-tm-variant-1">
  <span>Left accent variant</span>
</div>

<!-- Variant 2: outline glow -->
<div class="tm-keyframes-slide-tm tm-keyframes-slide-tm-variant-2">
  <span>Outline glow variant</span>
</div>

<!-- Variant 3: tall column -->
<div class="tm-keyframes-slide-tm tm-keyframes-slide-tm-variant-3">
  <span>Tall column variant</span>
</div>

<!-- Variant 4: shadow depth -->
<div class="tm-keyframes-slide-tm tm-keyframes-slide-tm-variant-4">
