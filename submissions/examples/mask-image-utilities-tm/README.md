...
Css mask-image with gradient masks creating fade-edge and spotlight effects. This submission demonstrates how to leverage the EaseMotion CSS design token system (--ease-* variables) for consistent styling across your project.
