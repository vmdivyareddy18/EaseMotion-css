...
This submission provides a comprehensive set of CSS utility classes for **CSS Isolation**, built on the EaseMotion CSS design token system from `core/variables.css`.
...
```html
<link rel="stylesheet" href="submissions/examples/isolation-tm/style.css" />
```
...
```
submissions/examples/isolation-tm/
