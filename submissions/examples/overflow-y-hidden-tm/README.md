# overflow-y-hidden-tm

## CSS CSS overflow-y vertical clip

A comprehensive CSS utility class for **CSS overflow-y vertical clip**. Part of the EaseMotion CSS framework — a curated collection of modern CSS utilities designed for rapid UI development.

## Usage

```html
<!-- Basic usage -->
<div class="tm-overflow-y-hidden-tm">
  <span>CSS overflow-y vertical clip</span>
</div>

<!-- Variant 1: left-accent border -->
<div class="tm-overflow-y-hidden-tm tm-overflow-y-hidden-tm-variant-1">
  <span>Left accent variant</span>
</div>

<!-- Variant 2: outline glow -->
<div class="tm-overflow-y-hidden-tm tm-overflow-y-hidden-tm-variant-2">
  <span>Outline glow variant</span>
</div>

<!-- Variant 3: tall column -->
<div class="tm-overflow-y-hidden-tm tm-overflow-y-hidden-tm-variant-3">
  <span>Tall column variant</span>
</div>

<!-- Variant 4: shadow depth -->
<div class="tm-overflow-y-hidden-tm tm-overflow-y-hidden-tm-variant-4">
