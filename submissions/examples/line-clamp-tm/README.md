...
This submission provides a comprehensive set of CSS utility classes for **CSS Line Clamp Utilities**, built on the EaseMotion CSS design token system from `core/variables.css`.
...
```html
<link rel="stylesheet" href="submissions/examples/line-clamp-tm/style.css" />
```
...
```
submissions/examples/line-clamp-tm/
