...
Opentype font-feature-settings for ligatures kerning and alternates using ease-font-mono. This submission demonstrates how to leverage the EaseMotion CSS design token system (--ease-* variables) for consistent styling across your project.
