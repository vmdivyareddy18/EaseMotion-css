# CSS Scrollbar Thumb Styles

**Category:** Interaction
**Slug:** `scrollbar-thumb-tm`

## Overview

Cursors, scroll, selection, and user interaction styles.

This submission provides a comprehensive set of CSS utility classes for **CSS Scrollbar Thumb Styles**, built on the EaseMotion CSS design token system from `core/variables.css`.
...
```html
<link rel="stylesheet" href="submissions/examples/scrollbar-thumb-tm/style.css" />
```
...
```
submissions/examples/scrollbar-thumb-tm/
