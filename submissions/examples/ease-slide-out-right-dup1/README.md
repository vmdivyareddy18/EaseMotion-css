# ease-slide-out-right – Slide Out Right Exit

A simple exit animation: the element slides to the right while fading out. Perfect for dismissing items or confirming actions.
...
- Adding the class .exit triggers a CSS transition that moves the card 40px to the right and fades it to transparent over 0.3 seconds with an ease-in curve.
- A “Reset” button removes the class, bringing the card back instantly.
- The effect respects prefers-reduced-motion: the element simply disappears without sliding.
