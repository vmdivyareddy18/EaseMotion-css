# max-height-expand-tm

## CSS CSS max-height expansion utilities

A comprehensive CSS utility class for **CSS max-height expansion utilities**. Part of the EaseMotion CSS framework — a curated collection of modern CSS utilities designed for rapid UI development.

## Usage

```html
<!-- Basic usage -->
<div class="tm-max-height-expand-tm">
  <span>CSS max-height expansion utilities</span>
</div>

<!-- Variant 1: left-accent border -->
<div class="tm-max-height-expand-tm tm-max-height-expand-tm-variant-1">
  <span>Left accent variant</span>
</div>

<!-- Variant 2: outline glow -->
<div class="tm-max-height-expand-tm tm-max-height-expand-tm-variant-2">
  <span>Outline glow variant</span>
</div>

<!-- Variant 3: tall column -->
<div class="tm-max-height-expand-tm tm-max-height-expand-tm-variant-3">
  <span>Tall column variant</span>
</div>

<!-- Variant 4: shadow depth -->
<div class="tm-max-height-expand-tm tm-max-height-expand-tm-variant-4">
