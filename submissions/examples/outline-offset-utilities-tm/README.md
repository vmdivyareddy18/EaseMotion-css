...
Outline-offset spacing from element edge with focus-visible glow effects. This submission demonstrates how to leverage the EaseMotion CSS design token system (--ease-* variables) for consistent styling across your project.
