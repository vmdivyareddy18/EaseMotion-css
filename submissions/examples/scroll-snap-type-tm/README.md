...
Scroll-snap-type x mandatory y proximity with ease-ease timing functions. This submission demonstrates how to leverage the EaseMotion CSS design token system (--ease-* variables) for consistent styling across your project.
