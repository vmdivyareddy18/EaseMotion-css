...
Animated gradient text effects with shimmer, pulse, and flow variants using CSS background-clip and keyframe animations

## Features

- gradient-shimmer: left-to-right shimmer sweep on gradient text
- gradient-pulse: subtle scale + opacity pulse on gradient text
- gradient-flow: rotating conic-gradient flow effect
- gradient-rainbow: multi-color cycling animation
- gradient-diamond: diamond-pattern gradient animation
...
<link rel="stylesheet" href="submissions/examples/gradient-text-animations-tm/style.css">
```
