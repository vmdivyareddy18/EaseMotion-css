...
**Category:** Transform
**Slug:** `transform-translate-tm`

## Overview

CSS 2D and 3D transform utilities.

This submission provides a comprehensive set of CSS utility classes for **CSS Transform Translate**, built on the EaseMotion CSS design token system from `core/variables.css`.
...
```html
<link rel="stylesheet" href="submissions/examples/transform-translate-tm/style.css" />
```
...
```
submissions/examples/transform-translate-tm/
