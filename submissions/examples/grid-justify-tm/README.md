# CSS Grid Justify Items & Content

**Category:** Layout
**Slug:** `grid-justify-tm`

## Overview

CSS layout utilities for flexbox and grid systems.

This submission provides a comprehensive set of CSS utility classes for **CSS Grid Justify Items & Content**, built on the EaseMotion CSS design token system from `core/variables.css`.
...
```html
<link rel="stylesheet" href="submissions/examples/grid-justify-tm/style.css" />
```
...
```
submissions/examples/grid-justify-tm/
  demo.html    — Interactive demo with live examples
  style.css    — 133+ meaningful CSS lines
