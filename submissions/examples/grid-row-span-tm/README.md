# CSS Grid Row Span Utilities

**Category:** Layout
**Slug:** `grid-row-span-tm`

## Overview

CSS layout utilities for flexbox and grid systems.

This submission provides a comprehensive set of CSS utility classes for **CSS Grid Row Span Utilities**, built on the EaseMotion CSS design token system from `core/variables.css`.
...
```html
<link rel="stylesheet" href="submissions/examples/grid-row-span-tm/style.css" />
```
...
```
submissions/examples/grid-row-span-tm/
