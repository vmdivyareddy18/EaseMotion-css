...
Pointer-events none for click-through overlays and passthrough clickable elements. This submission demonstrates how to leverage the EaseMotion CSS design token system (--ease-* variables) for consistent styling across your project.
