...
This submission provides a comprehensive set of CSS utility classes for **CSS Scroll Snap Points**, built on the EaseMotion CSS design token system from `core/variables.css`.
...
```html
<link rel="stylesheet" href="submissions/examples/scroll-snap-tm/style.css" />
```
...
```
submissions/examples/scroll-snap-tm/
