# ease-fade-in-like-button

**Issue:** #41650 — [FEATURE] Like Button with Fade In Animation

## What does this do?

A like button with a smooth fade-in animation that reveals the liked state with a gentle opacity transition.
...
```html
<!-- Example usage -->
<div class="ease-fade-in-like-button">
  <!-- Your content here -->
</div>
```
