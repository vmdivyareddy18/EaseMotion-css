...
const rootDir = path.resolve(__dirname, "../../../"); // Adjusted path to root from submissions/examples/validate-bundle-fix-pr/
...
// Normalize CRLF to LF line endings to ensure Windows compatibility
