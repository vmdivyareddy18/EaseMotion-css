# MoneyMentor – Finance Coach Landing Page

A complete, ready‑to‑copy landing page for a personal finance educator built entirely with **EaseMotion CSS** utility classes – no custom keyframes.

## Sections
- **Header** – clean navigation
- **Hero** – financial freedom imagery with a free guide CTA
- **Programs** – debt freedom, investing basics, wealth building
- **About the Coach** – photo, bio, credentials
- **Client Results** – success stories
- **Pricing Packages** – three tiered plans
- **Free Resource Download CTA** – green call‑to‑action section
...
- **Typography:** `ease-text-*`, `ease-font-bold`, `ease-font-semibold`, `ease-text-gray-*`, `ease-text-green-*`, `ease-text-white`
- **Spacing:** `ease-py-*`, `ease-px-*`, `ease-p-*`, `ease-mb-*`, `ease-mt-*`
- **Components:** `ease-btn`, `ease-btn-primary`, `ease-btn-lg`, `ease-card`, `ease-input`
- **Hover Effects:** `ease-hover-scale-105`, `ease-hover-shadow-xl`, `ease-hover-text-green-700`
