# height-fit-content-tm

## CSS CSS height fit-content intrinsic sizing

A comprehensive CSS utility class for **CSS height fit-content intrinsic sizing**. Part of the EaseMotion CSS framework — a curated collection of modern CSS utilities designed for rapid UI development.

## Usage

```html
<!-- Basic usage -->
<div class="tm-height-fit-content-tm">
  <span>CSS height fit-content intrinsic sizing</span>
</div>

<!-- Variant 1: left-accent border -->
<div class="tm-height-fit-content-tm tm-height-fit-content-tm-variant-1">
  <span>Left accent variant</span>
</div>

<!-- Variant 2: outline glow -->
<div class="tm-height-fit-content-tm tm-height-fit-content-tm-variant-2">
  <span>Outline glow variant</span>
</div>

<!-- Variant 3: tall column -->
<div class="tm-height-fit-content-tm tm-height-fit-content-tm-variant-3">
  <span>Tall column variant</span>
</div>

<!-- Variant 4: shadow depth -->
<div class="tm-height-fit-content-tm tm-height-fit-content-tm-variant-4">
