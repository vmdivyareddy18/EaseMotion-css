...
## CSS CSS @keyframes spin rotation animation

A comprehensive CSS utility class for **CSS @keyframes spin rotation animation**. Part of the EaseMotion CSS framework — a curated collection of modern CSS utilities designed for rapid UI development.

## Usage

```html
<!-- Basic usage -->
<div class="tm-keyframes-spin-tm">
  <span>CSS @keyframes spin rotation animation</span>
</div>

<!-- Variant 1: left-accent border -->
<div class="tm-keyframes-spin-tm tm-keyframes-spin-tm-variant-1">
  <span>Left accent variant</span>
</div>

<!-- Variant 2: outline glow -->
<div class="tm-keyframes-spin-tm tm-keyframes-spin-tm-variant-2">
  <span>Outline glow variant</span>
</div>

<!-- Variant 3: tall column -->
<div class="tm-keyframes-spin-tm tm-keyframes-spin-tm-variant-3">
  <span>Tall column variant</span>
</div>

<!-- Variant 4: shadow depth -->
<div class="tm-keyframes-spin-tm tm-keyframes-spin-tm-variant-4">
