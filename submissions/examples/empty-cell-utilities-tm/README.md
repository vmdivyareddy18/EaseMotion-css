# Empty Cell Utilities

Empty-cells show hide for table cells with border-collapse integration. This submission demonstrates how to leverage the EaseMotion CSS design token system (--ease-* variables) for consistent styling across your project.
