...
**Slug:** `object-position-tm`

## Overview

Shadows, filters, clip-paths, and other visual enhancements.

This submission provides a comprehensive set of CSS utility classes for **CSS Object Position**, built on the EaseMotion CSS design token system from `core/variables.css`.
...
```html
<link rel="stylesheet" href="submissions/examples/object-position-tm/style.css" />
```
...
```
submissions/examples/object-position-tm/
