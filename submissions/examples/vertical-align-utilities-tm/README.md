...
Vertical-align top middle bottom text-top text-bottom for table and inline layouts. This submission demonstrates how to leverage the EaseMotion CSS design token system (--ease-* variables) for consistent styling across your project.
