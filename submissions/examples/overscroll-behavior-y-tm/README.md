# overscroll-behavior-y-tm

## CSS CSS overscroll-behavior-y vertical boundary

A comprehensive CSS utility class for **CSS overscroll-behavior-y vertical boundary**. Part of the EaseMotion CSS framework — a curated collection of modern CSS utilities designed for rapid UI development.

## Usage

```html
<!-- Basic usage -->
<div class="tm-overscroll-behavior-y-tm">
  <span>CSS overscroll-behavior-y vertical boundary</span>
</div>

<!-- Variant 1: left-accent border -->
<div class="tm-overscroll-behavior-y-tm tm-overscroll-behavior-y-tm-variant-1">
  <span>Left accent variant</span>
</div>

<!-- Variant 2: outline glow -->
<div class="tm-overscroll-behavior-y-tm tm-overscroll-behavior-y-tm-variant-2">
  <span>Outline glow variant</span>
</div>

<!-- Variant 3: tall column -->
<div class="tm-overscroll-behavior-y-tm tm-overscroll-behavior-y-tm-variant-3">
  <span>Tall column variant</span>
</div>

<!-- Variant 4: shadow depth -->
<div class="tm-overscroll-behavior-y-tm tm-overscroll-behavior-y-tm-variant-4">
