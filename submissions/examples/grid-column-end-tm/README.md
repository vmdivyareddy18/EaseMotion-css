...
## CSS CSS Grid column-end property — spanning columns dynamically

A comprehensive CSS utility class for **CSS Grid column-end property — spanning columns dynamically**. Part of the EaseMotion CSS framework — a curated collection of modern CSS utilities designed for rapid UI development.

## Usage

```html
<!-- Basic usage -->
<div class="tm-grid-column-end-tm">
  <span>CSS Grid column-end property — spanning columns dynamically</span>
</div>

<!-- Variant 1: left-accent border -->
<div class="tm-grid-column-end-tm tm-grid-column-end-tm-variant-1">
  <span>Left accent variant</span>
</div>

<!-- Variant 2: outline glow -->
<div class="tm-grid-column-end-tm tm-grid-column-end-tm-variant-2">
  <span>Outline glow variant</span>
</div>

<!-- Variant 3: tall column -->
<div class="tm-grid-column-end-tm tm-grid-column-end-tm-variant-3">
  <span>Tall column variant</span>
</div>

<!-- Variant 4: shadow depth -->
<div class="tm-grid-column-end-tm tm-grid-column-end-tm-variant-4">
