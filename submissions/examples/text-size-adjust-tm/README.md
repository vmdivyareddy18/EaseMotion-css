...
Text-size-adjust auto none for mobile viewport scaling control. This submission demonstrates how to leverage the EaseMotion CSS design token system (--ease-* variables) for consistent styling across your project.
