...
Hanging and regular text-indent for drop-cap and paragraph indentation demos. This submission demonstrates how to leverage the EaseMotion CSS design token system (--ease-* variables) for consistent styling across your project.
