...
## CSS CSS Grid row gap spacing utilities

A comprehensive CSS utility class for **CSS Grid row gap spacing utilities**. Part of the EaseMotion CSS framework — a curated collection of modern CSS utilities designed for rapid UI development.

## Usage

```html
<!-- Basic usage -->
<div class="tm-grid-row-gap-tm">
  <span>CSS Grid row gap spacing utilities</span>
</div>

<!-- Variant 1: left-accent border -->
<div class="tm-grid-row-gap-tm tm-grid-row-gap-tm-variant-1">
  <span>Left accent variant</span>
</div>

<!-- Variant 2: outline glow -->
<div class="tm-grid-row-gap-tm tm-grid-row-gap-tm-variant-2">
  <span>Outline glow variant</span>
</div>

<!-- Variant 3: tall column -->
<div class="tm-grid-row-gap-tm tm-grid-row-gap-tm-variant-3">
  <span>Tall column variant</span>
</div>

<!-- Variant 4: shadow depth -->
<div class="tm-grid-row-gap-tm tm-grid-row-gap-tm-variant-4">
