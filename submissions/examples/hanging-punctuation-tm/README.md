...
**Category:** Typography
**Slug:** `hanging-punctuation-tm`

## Overview

Text and font styling utilities for readability and visual hierarchy.

This submission provides a comprehensive set of CSS utility classes for **CSS Hanging Punctuation**, built on the EaseMotion CSS design token system from `core/variables.css`.
...
```html
<link rel="stylesheet" href="submissions/examples/hanging-punctuation-tm/style.css" />
```
...
```
submissions/examples/hanging-punctuation-tm/
