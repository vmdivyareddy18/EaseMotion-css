# Zoom-Out Cyberpunk Neon Popover

## What does this do?
A pure CSS animated popover with zoom-out animation, designed for Cyberpunk Neon layouts with neon glow effects, scan lines, and futuristic UI.
...
<div class="popover-container">
  ...
  <div class="zoom-popover" role="tooltip">
    ...
    <div class="zoom-header">
      <span class="zoom-status">ONLINE</span>
      <span class="zoom-signal">
...
## Why is it useful?
- **Zoom-out animation** with neon reveals
- **Cyberpunk Neon optimized** with neon glow and futuristic UI
- **Multiple animation variants** (glitch, flicker, scan) for different UX needs
...
| Class | Effect |
|-------|--------|
| `.glitch` | Glitch hue-rotate zoom |
| `.flicker` | Flicker opacity zoom |
| `.scan` | Scan clip-path zoom |
