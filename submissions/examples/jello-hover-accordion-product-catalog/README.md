# CSS Jello-Hover Accordion — Product Catalog Layout

A pure CSS accordion where each header wobbles playfully on hover, styled for product detail sections like specs, sizing, and shipping info.
...
| `--ease-accordion-accent`          | `#ea580c`                                     | Accent color (icon, hover background)      |
| `--ease-accordion-accent-soft`     | `#ffedd5`                                     | Soft accent background on header hover     |
| `--ease-accordion-radius`          | `12px`                                        | Panel corner radius                        |
| `--ease-accordion-max-width`       | `480px`                                       | Maximum accordion width                    |
| `--ease-accordion-focus-ring`      | `#ea580c`                                     | Focus outline color                        |
...
<div class="ease-accordion">
  <div class="ease-accordion__item" data-open="false">
    ...
    <div class="ease-accordion__panel">
      <div class="ease-accordion__body">Detail content</div>
    </div>
  </div>
</div>
```
