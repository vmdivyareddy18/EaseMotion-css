...
Tight normal wide and extra-wide letter-spacing using ease-text tokens. This submission demonstrates how to leverage the EaseMotion CSS design token system (--ease-* variables) for consistent styling across your project.
