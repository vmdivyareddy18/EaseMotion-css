# flex-wrap-reverse-tm

## CSS CSS flex-wrap reverse wrapping

A comprehensive CSS utility class for **CSS flex-wrap reverse wrapping**. Part of the EaseMotion CSS framework — a curated collection of modern CSS utilities designed for rapid UI development.

## Usage

```html
<!-- Basic usage -->
<div class="tm-flex-wrap-reverse-tm">
  <span>CSS flex-wrap reverse wrapping</span>
</div>

<!-- Variant 1: left-accent border -->
<div class="tm-flex-wrap-reverse-tm tm-flex-wrap-reverse-tm-variant-1">
  <span>Left accent variant</span>
</div>

<!-- Variant 2: outline glow -->
<div class="tm-flex-wrap-reverse-tm tm-flex-wrap-reverse-tm-variant-2">
  <span>Outline glow variant</span>
</div>

<!-- Variant 3: tall column -->
<div class="tm-flex-wrap-reverse-tm tm-flex-wrap-reverse-tm-variant-3">
  <span>Tall column variant</span>
</div>

<!-- Variant 4: shadow depth -->
<div class="tm-flex-wrap-reverse-tm tm-flex-wrap-reverse-tm-variant-4">
