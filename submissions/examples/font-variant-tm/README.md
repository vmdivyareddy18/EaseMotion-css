...
**Category:** Typography
**Slug:** `font-variant-tm`

## Overview

Text and font styling utilities for readability and visual hierarchy.

This submission provides a comprehensive set of CSS utility classes for **CSS Font Variant Numeric**, built on the EaseMotion CSS design token system from `core/variables.css`.
...
```html
<link rel="stylesheet" href="submissions/examples/font-variant-tm/style.css" />
```
...
```
submissions/examples/font-variant-tm/
