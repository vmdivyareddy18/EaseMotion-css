# filter-brightness-tm

## CSS CSS filter brightness adjustment

A comprehensive CSS utility class for **CSS filter brightness adjustment**. Part of the EaseMotion CSS framework — a curated collection of modern CSS utilities designed for rapid UI development.

## Usage

```html
<!-- Basic usage -->
<div class="tm-filter-brightness-tm">
  <span>CSS filter brightness adjustment</span>
</div>

<!-- Variant 1: left-accent border -->
<div class="tm-filter-brightness-tm tm-filter-brightness-tm-variant-1">
  <span>Left accent variant</span>
</div>

<!-- Variant 2: outline glow -->
<div class="tm-filter-brightness-tm tm-filter-brightness-tm-variant-2">
  <span>Outline glow variant</span>
</div>

<!-- Variant 3: tall column -->
<div class="tm-filter-brightness-tm tm-filter-brightness-tm-variant-3">
  <span>Tall column variant</span>
</div>

<!-- Variant 4: shadow depth -->
<div class="tm-filter-brightness-tm tm-filter-brightness-tm-variant-4">
