# text-wrap: balance CSS Utility

CSS text-wrap: balance utilities for improved readability of headings and short text blocks. Demonstrates the difference between balanced and standard wrapping with real-world typography examples.

## Features

- Demonstrates text-wrap: balance css utility using EaseMotion CSS design tokens
