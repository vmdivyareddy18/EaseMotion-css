...
This submission provides a comprehensive set of CSS utility classes for **CSS Grid Align Items & Content**, built on the EaseMotion CSS design token system from `core/variables.css`.
...
```html
<link rel="stylesheet" href="submissions/examples/grid-align-tm/style.css" />
```
...
```
submissions/examples/grid-align-tm/
